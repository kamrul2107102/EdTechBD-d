...
,      
    {
        ...
        rating: 5,
        feedback: "Imagify has completely transformed the way I create content. Its intuitive interface saves me hours every week, allowing me to focus on designing and innovating. The quality of the output is consistently amazing, and I never have to worry about image compression or resolution loss. Collaboration with my team has become seamless, as everyone can access optimized assets instantly. I highly recommend Imagify to any professional looking to streamline their creative workflow.",
    },
    {
        name: 'Liam Rodriguez',
        role: 'Backend Engineer @ Spotify',
